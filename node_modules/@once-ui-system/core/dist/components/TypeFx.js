...
import { Text } from ".";
const TypeFx = ({ words, speed = 100, delay = 0, hold = 2000, trigger = "instant", onTrigger, loop = true, children, ...text }) => {
    ...
    useEffect(() => {
        ...
        const run = async () => {
            const wordsArray = JSON.parse(wordsHash);
    ...
    return (_jsxs(Text, { ...text, children: [children, displayText, !isComplete && _jsx("span", { style: { opacity: 0.5 }, children: "|" })] }));
};
TypeFx.displayName = "TypeFx";
export { TypeFx };
//# sourceMappingURL=TypeFx.js.map