...
const BlobFx = ({ seed = 0, ...flex }) => {
    ...
    return (_jsxs(Row, { fill: true, pointerEvents: "none", overflow: "hidden", style: { filter: "blur(2rem)" }, ...flex, children: [_jsx(Background, { position: "absolute", fill: true, bottom: "0", left: "0", gradient: {
                    display: true,
                ...
                } }), _jsx(Background, { position: "absolute", fill: true, bottom: "0", left: "-20%", gradient: {
                    display: true,
                ...
                } }), _jsx(Background, { position: "absolute", fill: true, bottom: "0", left: "10%", gradient: {
                    display: true,
...
export { BlobFx };
//# sourceMappingURL=BlobFx.js.map