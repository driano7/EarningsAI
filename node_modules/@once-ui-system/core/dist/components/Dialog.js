...
const Dialog = forwardRef(({ closeOnClickaway = true, isOpen, onClose, title, description, children, stack, base, footer, onHeightChange, minHeight, ...rest }, ref) => {
