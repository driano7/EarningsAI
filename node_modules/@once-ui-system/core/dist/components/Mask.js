...
const Mask = forwardRef(({ cursor = false, x, y, radius = 50, reducedMotion = "auto", children, className, style, ...rest }, forwardedRef) => {
    ...
    const writeCssVars = useCallback((px, py) => {
    ...
    return (_jsx(Flex, { ref: maskRef, fill: true, className: classNames(styles.mask, className), top: "0", left: "0", zIndex: 0, overflow: "hidden", style: {
            ...maskStyle(),
            ...style,
