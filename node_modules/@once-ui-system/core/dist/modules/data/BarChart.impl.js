...
const BarChart = ({ title, description, data, series, date, emptyState, errorState, error = false, loading = false, tooltip = true, legend: legendProp = {}, axis = "both", grid = "y", border = "neutral-alpha-weak", variant: variantProp, barWidth = "l", hover = false, reverseY = false, reverseX = false, "data-viz-style": dataVizStyle, ...flex }) => {
    ...
    return (_jsxs(Column, { fillWidth: true, minHeight: height, border: border, radius: "l", "data-viz-style": dataVizStyle || mode, ...flex, children: [_jsx(ChartHeader, { title: title, description: description, dateRange: selectedDateRange, date: date, onDateRangeChange: handleDateRangeChange, presets: date?.presets }), _jsxs(Row, { fill: true, borderTop: (title || description || date?.selector) ? (border || "neutral-alpha-weak") : undefined, topRadius: flex.radius || "l", overflow: "hidden", children: [_jsx(ChartStatus, { loading: loading, empty: !filteredData || filteredData.length === 0, emptyState: emptyState, error: error, errorState: errorState }), !loading && !error && filteredData && filteredData.length > 0 && rc && (() => {
                        ...
                        return (_jsx(ResponsiveContainer, { width: "100%", height: "100%", children: _jsxs(RBarChart, { data: filteredData, margin: { left: 0, bottom: 0, top: 0, right: 0 }, barGap: 4, children: [_jsx(CartesianGrid, { vertical: grid === "x" || grid === "both", horizontal: grid === "y" || grid === "both", stroke: "var(--neutral-alpha-weak)" }), legend.display && (_jsx(RLegend, { content: legendContent, wrapperStyle: legendWrapperStyle })), _jsx(XAxis, { dataKey: xAxisKey, axisLine: false, tickLine: tickLine, orientation: reverseX ? "top" : "bottom", tick: axis === "x" || axis === "both"
                                        ...
                                        }, hide: !(axis === "x" || axis === "both") }), (axis === "y" || axis === "both") && (_jsx(YAxis, { allowDataOverflow: true, width: 64, padding: { top: 40 }, orientation: reverseY ? "right" : "left", tickLine: tickLine, tick: { fill: tickFill, fontSize: tickFontSize }, axisLine: { stroke: axisLineStroke } })), tooltip && (_jsx(Tooltip, { cursor: { fill: hover ? "var(--neutral-alpha-weak)" : "var(--static-transparent)" }, content: (props) => (_jsx(DataTooltip, { ...props, date: date, variant: variant })) })), _jsx("defs", { children: barColors.map((color, index) => (_jsx(LinearGradient, { id: `barGradient${chartId}${index}`, color: color, variant: variant }, `gradient-${chartId}-${index}`))) }), autoSeries.map((series, index) => (_jsx(Bar, { dataKey: series.key, name: series.key, fill: `url(#barGradient${chartId}${index})`, stroke: barColors[index], strokeWidth: 1, transform: "translate(0, -1)", barSize: barWidth === "fill" ? "100%" :
                                            barWidth === "xs" ? 12 :
                                                barWidth === "s" ? 16 :
                                                    barWidth === "m" ? 24 :
                                                        barWidth === "l" ? 40 :
                                                            barWidth === "xl" ? 64 : barWidth, radius: barWidth === "fill" || barWidth === "xl" ? [10, 10, 10, 10] : [6, 6, 6, 6] }, series.key)))] }) }));
                    })()] })] }));
};
BarChart.displayName = "BarChart";
export default BarChart;
//# sourceMappingURL=BarChart.impl.js.map