...
const LineBarChart = ({ title, description, data, series, date, emptyState, errorState, error = false, loading = false, tooltip = true, legend: legendProp = {}, grid = "y", axis = "both", border = "neutral-alpha-weak", variant: variantProp, barWidth = "l", curve = "natural", reverseY = false, reverseX = false, "data-viz-style": dataVizStyle, ...flex }) => {
    ...
    return (_jsxs(Column, { fillWidth: true, height: height, border: border, radius: "l", "data-viz-style": dataVizStyle || mode, ...flex, children: [_jsx(ChartHeader, { title: title, description: description, dateRange: selectedDateRange, date: date, onDateRangeChange: handleDateRangeChange, presets: date?.presets }), _jsxs(Row, { fill: true, borderTop: (title || description || date?.selector) ? (border || "neutral-alpha-weak") : undefined, topRadius: flex.radius || "l", overflow: "hidden", children: [_jsx(ChartStatus, { loading: loading, empty: !filteredData || filteredData.length === 0, emptyState: emptyState, error: error, errorState: errorState }), !loading && !error && filteredData && filteredData.length > 0 && rc && (() => {
                        ...
                        return (_jsx(ResponsiveContainer, { width: "100%", height: "100%", children: _jsxs(ComposedChart, { data: filteredData, margin: { left: 0, bottom: 0, top: 0, right: 0 }, barGap: 4, children: [_jsxs("defs", { children: [_jsx(LinearGradient, { id: `barGradient${chartId}`, color: finalBarColor, variant: variant }), _jsx(LinearGradient, { id: `lineGradient${chartId}`, color: finalLineColor, variant: variant })] }), _jsx(CartesianGrid, { vertical: grid === "x" || grid === "both", horizontal: grid === "y" || grid === "both", stroke: "var(--neutral-alpha-weak)" }), legend.display && (_jsx(RLegend, { content: legendContent, wrapperStyle: legendWrapperStyle })), _jsx(XAxis, { height: 32, tickMargin: 6, dataKey: xAxisKey, hide: !(axis === "x" || axis === "both"), orientation: reverseX ? "top" : "bottom", axisLine: { stroke: axisLineStroke }, tickLine: tickLine, tick: { fill: tickFill, fontSize: tickFontSize }, tickFormatter: (value) => {
                                            const dataPoint = data.find((item) => item[xAxisKey] === value);
                                            return formatDate(value, date, dataPoint);
                                        } }), (axis === "y" || axis === "both") && (_jsx(YAxis, { width: 64, padding: { top: 40 }, allowDataOverflow: true, orientation: reverseY ? "right" : "left", tickLine: tickLine, tick: { fill: tickFill, fontSize: tickFontSize }, axisLine: { stroke: axisLineStroke } })), tooltip && (_jsx(Tooltip, { cursor: { stroke: "var(--neutral-border-strong)", strokeWidth: 1 }, content: (props) => (_jsx(DataTooltip, { ...props, variant: variant, date: date, dataKey: xAxisKey })) })), _jsx(Area, { type: curve, dataKey: lineSeries.key, name: lineSeries.key, stroke: finalLineColor, transform: "translate(0, -1)", fill: `url(#lineGradient${chartId})`, activeDot: { r: 4, fill: finalLineColor, stroke: "var(--background)", strokeWidth: 0 } }), _jsx(Bar, { dataKey: barSeries.key, name: barSeries.key, fill: `url(#barGradient${chartId})`, stroke: finalBarColor, strokeWidth: 1, transform: "translate(0, -1)", radius: [4, 4, 4, 4], barSize: barWidth === "fill" ? "100%" :
                                            barWidth === "xs" ? 6 :
                                                barWidth === "s" ? 12 :
                                                    barWidth === "m" ? 20 :
                                                        barWidth === "l" ? 40 :
...
//# sourceMappingURL=LineBarChart.impl.js.map