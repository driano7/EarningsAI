...
export const SP500: SP500Company[] = [
  ...
  { ticker: "ANSS", name: "ANSYS", sector: "Information Technology" },
  ...
  { ticker: "BXP", name: "Boston Properties", sector: "Real Estate" },
  ...
  { ticker: "CTLT", name: "Catalent", sector: "Health Care" },
  ...
  { ticker: "COO", name: "CooperCompanies", sector: "Health Care" },
  ...
  { ticker: "EL", name: "Estée Lauder Companies", sector: "Consumer Staples" },
  ...
  { ticker: "HIG", name: "Hartford Insurance", sector: "Financials" },
  ...
  { ticker: "PNW", name: "Pinnacle West", sector: "Utilities" },
  ...
  { ticker: "SJM", name: "J.M. Smucker Company", sector: "Consumer Staples" },
  ...
  { ticker: "SMCI", name: "Supermicro Computer", sector: "Information Technology" },
  ...
  { ticker: "TFX", name: "Teleflex", sector: "Health Care" },
